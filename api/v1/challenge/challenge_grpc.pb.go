...
func (c *challengeStoreClient) CreateChallenge(ctx context.Context, in *CreateChallengeRequest, opts ...grpc.CallOption) (*Challenge, error) {
	out := new(Challenge)
	err := c.cc.Invoke(ctx, ChallengeStore_CreateChallenge_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *challengeStoreClient) RetrieveChallenge(ctx context.Context, in *RetrieveChallengeRequest, opts ...grpc.CallOption) (*Challenge, error) {
	out := new(Challenge)
	err := c.cc.Invoke(ctx, ChallengeStore_RetrieveChallenge_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *challengeStoreClient) QueryChallenge(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (ChallengeStore_QueryChallengeClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChallengeStore_ServiceDesc.Streams[0], ChallengeStore_QueryChallenge_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &challengeStoreQueryChallengeClient{stream}
...
type challengeStoreQueryChallengeClient struct {
	grpc.ClientStream
}

func (x *challengeStoreQueryChallengeClient) Recv() (*Challenge, error) {
	m := new(Challenge)
...
func (c *challengeStoreClient) UpdateChallenge(ctx context.Context, in *UpdateChallengeRequest, opts ...grpc.CallOption) (*Challenge, error) {
	out := new(Challenge)
	err := c.cc.Invoke(ctx, ChallengeStore_UpdateChallenge_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *challengeStoreClient) DeleteChallenge(ctx context.Context, in *DeleteChallengeRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, ChallengeStore_DeleteChallenge_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedChallengeStoreServer) QueryChallenge(*emptypb.Empty, ChallengeStore_QueryChallengeServer) error {
...
func _ChallengeStore_QueryChallenge_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ChallengeStoreServer).QueryChallenge(m, &challengeStoreQueryChallengeServer{stream})
}
...
type challengeStoreQueryChallengeServer struct {
	grpc.ServerStream
}

func (x *challengeStoreQueryChallengeServer) Send(m *Challenge) error {
