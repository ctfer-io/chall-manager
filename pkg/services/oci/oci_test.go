...
func Test_F_OCI(t *testing.T) {
	...
	var tests = map[string]struct {
		...
		"named": {
			...
			Ref:          "docker.io/pandatix/license-lvl1",
			ExpectedName: "docker.io/pandatix/license-lvl1",
			ExpectedDig:  "sha256:acaca41979983579c871d13d407f2167c7394605fc08f3f36eb7484f12dbaf62",
		},
		"named-tagged": {
			Ref:          "docker.io/ctferio/chall-manager:v0.1.0-rc0",
			ExpectedName: "docker.io/ctferio/chall-manager",
			ExpectedDig:  "sha256:272a63ea0a75b63f6dc6e34bce0b8591c9fc15549a1298b3ee9e2685a38bff7e",
		},
		"invalid digest named-tagged": {
			//nolint:lll
			Ref:          "docker.io/ctferio/chall-manager:v0.1.0-rc0@sha256:db05b77564502a2db3409d0970810b8586b74d8fa40d0f234ca4a087d06c28d2", // actually the digest of v0.3.2
			ExpectedName: "docker.io/ctferio/chall-manager",
		...
		"canonical": {
			//nolint:lll
			Ref:          "docker.io/ctferio/chall-manager:v0.1.0-rc0@sha256:272a63ea0a75b63f6dc6e34bce0b8591c9fc15549a1298b3ee9e2685a38bff7e",
			ExpectedName: "docker.io/ctferio/chall-manager",
			ExpectedDig:  "sha256:272a63ea0a75b63f6dc6e34bce0b8591c9fc15549a1298b3ee9e2685a38bff7e",
		},
		"unexisting registry named-tagged": {
			// We expect this image to not exist in the local registry, giving an error
	...
	for testname, tt := range tests {
		t.Run(testname, func(t *testing.T) {
			name, dig, err := resolveDigest(t.Context(), tt.Ref, false, "", "")
